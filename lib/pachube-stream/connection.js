(function() {
  ...
  module.exports = Connection = (function() {
    function Connection(apiKey, options) {
      ...
      this.host = this.options.host || "api.cosm.com";
    ...
    Connection.prototype.post = function(resource, body, params, headers) {
      if (body == null) {
        body = {};
      }
      if (params == null) {
      ...
      return this.sendRequest(new HttpJsonRequest(this.apiKey, "post", resource, body, params, headers));
    };
    Connection.prototype.put = function(resource, body, params, headers) {
      if (body == null) {
        body = {};
      }
      if (params == null) {
      ...
      return this.sendRequest(new HttpJsonRequest(this.apiKey, "put", resource, body, params, headers));
    };
